CREATE TABLE "leetcode_chat_settings" (
	"tg_chat_uuid" uuid NOT NULL,
	"is_active" boolean DEFAULT true NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "leetcode_chat_settings_tg_chat_uuid_unique" UNIQUE("tg_chat_uuid")
);
...
--> statement-breakpoint
ALTER TABLE "leetcode_user_settings_entries" DISABLE ROW LEVEL SECURITY;--> statement-breakpoint
ALTER TABLE "leetcode_users_to_tg_chats" DISABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
ALTER TABLE "accepted_submissions" ADD COLUMN "leetcode_id" varchar NOT NULL;--> statement-breakpoint
ALTER TABLE "accepted_submissions" ADD COLUMN "submitted_at" timestamp NOT NULL;--> statement-breakpoint
ALTER TABLE "leetcode_chat_settings" ADD CONSTRAINT "leetcode_chat_settings_tg_chat_uuid_tg_chats_uuid_fk" FOREIGN KEY ("tg_chat_uuid") REFERENCES "public"."tg_chats"("uuid") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "accepted_submissions" DROP COLUMN "leetCodeId";--> statement-breakpoint
